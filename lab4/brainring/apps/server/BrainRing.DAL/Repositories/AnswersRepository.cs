...
{
    public class AnswersRepository : BaseRepository<Answer, AnswerEntity>, IAnswersRepository
    {
        public AnswersRepository(BrainRingDbContext context, IEntityMapper mapper) : base(context, mapper) { }
    }
}
